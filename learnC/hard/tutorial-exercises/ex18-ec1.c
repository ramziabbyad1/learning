...
main(int argc, char *argv[])
{
	...
	//test_sorting(numbers, count, test_sorting); //still compiles!
	//gives cast to incompatible pointer warning
	test_sorting(numbers, count, sorted_order);
	//test_sorting(numbers, count, NULL); //no compile warning but segfaults
	//valgrind indicates that we are trying to access invalid memory at 0x0 (NULL pointer address)
